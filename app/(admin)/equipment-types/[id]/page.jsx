...
export default async function EditEquipmentTypePage({ params }) {
  ...
  return <Container maxWidth="sm" sx={{ py: 4 }}><Typography variant="h4" sx={{ mb: 3 }}>Edit equipment type</Typography><AdminCrudForm action={updateEquipmentType} redirectTo="/equipment-types" initialValues={item} fields={[{ name: 'code', label: 'Code' }, { name: 'name', label: 'Name' }]} /></Container>;
}
