...
export default async function NewEquipmentPage(){
    ...
    return(
        <Container maxWidth = 'sm' sx ={{py:4}}>
            ...
            <EquipmentForm action={createAdminEquipment} initialValues={{ equipment_type_id: '', equipment_type: '', equipment_type_code: '', unit_number: '', name: '', site_name: '', site_code: '', room_area: '', status: lookups.statuses[0]?.code ?? '', amc_frequency: lookups.frequencies[0]?.code ?? '' }} {...lookups} submitLabel="Add equipment" />
        </Container>
    )
